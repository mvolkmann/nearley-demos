...
var grammar = {
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "main", "symbols": ["_", "statements", "_"], "postprocess":  d => {
          console.log('main d =', d);
          return nth(1);
        } },
    {"name": "statements", "symbols": ["statement"], "postprocess": id},
    {"name": "statements", "symbols": ["statement", {"literal":"."}, "_", "statements"], "postprocess": merge},
    ...
    {"name": "assignment", "symbols": ["identifier", "_", "assignment$string$1", "_", "expression"], "postprocess": 
        d => {
    ...
    {"name": "expression", "symbols": ["decimal"], "postprocess": id},
